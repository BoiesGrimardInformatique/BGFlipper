...
static void dolphin_process_event(FuriEventLoopObject* object, void* context) {
    ...
    if(event.type == DolphinEventTypeDeed) {
        ...
        // BGFlipper OS: aucun popup de level-up (retrait du ludique) — le compteur
        // XP continue en interne mais ne déclenche jamais d'animation dauphin.
        event.stats->level_up_is_pending = false;
