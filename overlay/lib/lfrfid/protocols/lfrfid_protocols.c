...
#include "protocol_indala224.h" // BGFlipper OS: porté depuis Unleashed (unlshd-089)
...
const ProtocolBase* const lfrfid_protocols[] = {
    ...
    [LFRFIDProtocolIndala224] = &protocol_indala224, // BGFlipper OS: Unleashed (unlshd-089)
};
